# Music and screen transitions

# self.shoot_cooldown = 10 | It was 20
# GRAVITY = 0.6 | It was 7.5
# Add layers of damage to player and enemy from grenade explosion
# enemy health, enemy = Soldier(..., 100) | It was 50
###################################################################################################################
import pygame
			...
			for x, tile in enumerate(row):
				if tile >= 0:
					...
					if tile >= 0 and tile <= 8:
						...
						player = Soldier('green', x * TILE_SIZE, y * TILE_SIZE, 1.65, 5, 20, 5, 100)
